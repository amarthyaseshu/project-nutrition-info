...
export const nutrientsData: nutrientsInterface[] = [
  ...
  },
  {
    ...
    description:
      'Vitamin D is essential for several reasons, including maintaining healthy bones and teeth. It may also protect against a range of diseases and conditions, such as type 1 diabetes. Supporting immune, brain, and nervous system health, regulating insulin levels and supporting diabetes management, supporting lung function and cardiovascular health, influencing the expression of genes involved in cancer development',
    essential_for:
      'Skin,Teeth,Bones,Growth,Muscle,During Pregnancy,Covid-19 Fight',
    foods:
      'sunlight, fatty fish such as salmon, egg yolks, cheese, beef liver, mushrooms, fortified milk, fortified cereals and juices',
  ...
  },
  {
    ...
    description:
      'Vitamin C is a vital nutrient for health. It helps form and maintain bones, skin, and blood vessels. Vitamin C is water soluble, and the body does not store it. To maintain adequate levels of vitamin C, humans need a daily intake of food that contains it. Vitamin C plays an important role in a number of bodily functions including the production of collagen, L-carnitine, and some neurotransmitters. It helps metabolize proteins and its antioxidant activity may reduce the risk of some cancers. People with adequate levels of vitamin C are thought to be better able to fight off infections compared to people with vitamin C deficiency. Vitamin C may also help prevent acute respiratory infections, especially in people with malnutrition and those who are physically stressed. Vitamin C may help in treating cancer. As an antioxidant, it protects the body against oxidative stress and helps prevent the oxidation of other molecules. Vitamin C may help in treating cancer. As an antioxidant, it protects the body against oxidative stress and helps prevent the oxidation of other molecules. Vitamin C may help in treating cancer. As an antioxidant, it protects the body against oxidative stress and helps prevent the oxidation of other molecules. Vitamin C may help in treating cancer. As an antioxidant, it protects the body against oxidative stress and helps prevent the oxidation of other molecules It appears to regenerate other antioxidants in the body, too.',
  ...
  },
  {
    ...
    foods:
      'cereals, beef, pork, nuts, whole grains, pulses, cauliflower, oranges, eggs, potatoes, asparagus, kale, white flour, white rice',
  ...
  },
  {
    ...
    foods:
      'Fish, meat, and poultry, such as turkey, chicken, beef, kidneys, and liver, eggs, dairy products, asparagus, avocados, fortified cereals, lima beans, navy beans, and peas, molasses, mushrooms, nuts, parsley,pumpkins,rosehips,sweet potatoes,cruciferous vegetables, such as broccoli, Brussels sprouts, spinach, dandelion greens, and watercress,whole-grain breads, enriched breads, and wheat bran',
    url: 'https://en.wikipedia.org/wiki/B_vitamins',
  },
  {
    ...
    essential_for: 'Hair',
    foods:
      'beef liver, chicken breast,turkey breast, salmon, brown rice, cereal, peanuts',
    url: 'https://en.wikipedia.org/wiki/B_vitamins',
  },
  {
    ...
    essential_for: 'Blood',
    foods:
      'Pork, chicken, turkey duck, beef, and especially animal organs such as liver and kidney, Salmon, lobster, and shellfish, whole grain breads and cereals. Whole grains are a good source of vitamin B5 but milling can remove up to 75 percent of the B5 content, egg yolk, milk, yogurt, and milk products, lentils, split peas, and soybeans, mushrooms, avocado, broccoli, sweet potatoes, corn, cauliflower, kale, and tomatoes. Other sources include brewer’s yeast, peanuts, sunflower seeds, wheat germ, royal jelly',
    url: 'https://en.wikipedia.org/wiki/B_vitamins',
  },
  {
    ...
    foods:
      'chick peas, beef liver, chicken breast, banana, tofu, avocados, brown rice, carrots, fish, cereal, milk, pork, potato, seeds, soy beans, spinach, turkey, whole grains',
    url: 'https://en.wikipedia.org/wiki/B_vitamins',
  },
  {
  ...
  },
  {
    ...
    description:
      'Folic acid is the synthetic form of folate, which is a naturally occurring B vitamin. Folate helps make DNA and other genetic material. It is especially important in prenatal health. It helps the body make healthy new red blood cells, for example. Red blood cells carry oxygen throughout the body. If the body does not make enough of these, a person can develop anemia, leading to fatigue, weakness, and a pale complexion. It is particularly important to get enough folate during pregnancy. Folate deficiency during pregnancy can lead to neural tube irregularities, such as spina bifida and anencephaly. ',
    essential_for: 'During Pregnancy,Muscle',
    foods:
      'beef liver, spinach, black-eyed peas, asparagus, brussels sprouts, lettuce, avocado, broccoli, mustard greens, green peas, kidney beans, tomato, crab, orange, peanuts, grapefruit, papaya, banana, hard-boiled egg',
    url: 'https://en.wikipedia.org/wiki/B_vitamins',
  },
  {
    ...
    foods: 'beef, pork, poultry, fish, milk, cheese, yogurt, eggs',
    url: 'https://en.wikipedia.org/wiki/B_vitamins',
  },
  {
